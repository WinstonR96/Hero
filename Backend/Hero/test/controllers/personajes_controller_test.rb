...
class PersonajesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personaje" do
    assert_difference('Personaje.count') do
      post personajes_url, params: { personaje: { description: @personaje.description, name: @personaje.name, photo: @personaje.photo } }, as: :json
    end
  ...
  test "should update personaje" do
    patch personaje_url(@personaje), params: { personaje: { description: @personaje.description, name: @personaje.name, photo: @personaje.photo } }, as: :json
    assert_response 200
  end
